...
import wp from '../main/weatherpage.module.css'
...
import UserLogo from '../../assets/Ellipse 33.svg'
const WeatherPage = () => {
    ...
    {data && (
      ...
      <>
        <div className={wp.main}>
         ...
         <div className={wp.sub__elements}>
          ...
          <div className={wp.main__block}>
            <div className={wp.block1}>
              <img className={wp.userLogo} src={UserLogo} alt="" />
              <img src={weatherLogo} />
              <p>weather</p>
